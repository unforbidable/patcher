...
namespace Patcher.Data.Plugins.Content.Records.Fallout4
{
    ...
    public sealed class Imgs : GenericFormRecord
    {
        ...
        public float DepthOfFieldUnknown1 { get { return (Dof ?? DefaultDof).Unknown1; } set { EnsureDofExists(); Dof.Unknown1 = value; } }
        public float DepthOfFieldUnknown2 { get { return (Dof ?? DefaultDof).Unknown2; } set { EnsureDofExists(); Dof.Unknown2 = value; } }
