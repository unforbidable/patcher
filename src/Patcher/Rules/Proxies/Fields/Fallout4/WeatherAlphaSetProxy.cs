...
{
    [Proxy(typeof(IWeatherAlphaSet))]
    public sealed class WeatherAlphaSetProxy : Proxy, IWeatherAlphaSet, IDumpabled
    {
        Wthr.FloatOctave target = null;

        internal WeatherAlphaSetProxy With(Wthr.FloatOctave target)
        {
            this.target = target;
            return this;
        }
